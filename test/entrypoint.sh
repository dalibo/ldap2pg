...
# keytab generated by samba init.
kinit -V -k -t "${PWD}/test/samba.keytab" Administrator
# maxssf disable GSSAPI encryption. We already use TLS.
# Samba refuses do combine TLS and GSSAPI encryption.
ldapsearch -v -Y GSSAPI -U Administrator -O maxssf=0 >/dev/null
