...
# Workaround PyPI requiring SNI. See
# https://github.com/pypa/pypi-support/issues/978
pip26_install() {
	mkdir -p ~/.cache/pip/curl
	local path="$HOME/.cache/pip/curl/${1##*/}"
	curl -L --output "$path" "$1"
	pip install --no-deps "$path"
}

"$pip" --version
if "$pip" --version |& grep -Fiq "python 2.6" ; then
	pip26_install https://files.pythonhosted.org/packages/53/67/9620edf7803ab867b175e4fd23c7b8bd8eba11cb761514dcd2e726ef07da/py-1.4.34-py2.py3-none-any.whl
	pip26_install https://files.pythonhosted.org/packages/fd/3e/d326a05d083481746a769fc051ae8d25f574ef140ad4fe7f809a2b63c0f0/pytest-3.1.3-py2.py3-none-any.whl
	pip26_install https://files.pythonhosted.org/packages/86/84/6bd1384196a6871a9108157ec934a1e1ee0078582cd208b43352566a86dc/pytest_catchlog-1.2.2-py2.py3-none-any.whl
	pip26_install https://files.pythonhosted.org/packages/4a/22/17b22ef5b049f12080f5815c41bf94de3c229217609e469001a8f80c1b3d/sh-1.12.14-py2.py3-none-any.whl
else
